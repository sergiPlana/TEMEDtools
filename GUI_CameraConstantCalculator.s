...
Class MainDialogClass:UIFrame {
	...
	TagGroup MainFrame(object self) {
		...
		TagGroup labelR = DLGCreateLabel("R / Physical Pixel Size (ľm):")
		...
		TagGroup labelLambda = DLGCreateLabel("Lambda / Wavelength (Ĺ):")
		...
		TagGroup labelPixelCali = DLGCreateLabel("d-1 / Pixel Calibration (Ĺ-1):")
